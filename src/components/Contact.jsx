          ...
          <div>
            ...
            <div className="mt-8 pt-8 border-t border-slate-200 dark:border-slate-750 transition-colors duration-300">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://linkedin.com/in/prasanga-niraula" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-white rounded-lg flex items-center justify-center hover:bg-purple-600 dark:hover:bg-purple-500 hover:text-white transition duration-200">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
