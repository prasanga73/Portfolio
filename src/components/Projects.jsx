export default function Projects() {
  const projects = [
    {
      ...
      description: 'AI-powered legal advisory application for Nepali law using Retrieval-Augmented Generation. Served as AI Lead — fine-tuned Mistral Nemo 12B, implemented RAG pipeline with pgvector, and built a citation reference system.',
  ...
  return (
    <section id="projects" style={{ padding: '120px 24px', borderTop: '1px solid var(--border-color)' }}>
