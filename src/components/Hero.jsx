export default function Hero() {
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-6 py-20">
      <div className="max-w-4xl text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-12">
          <a href="#projects" className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-lg hover:opacity-90 transition font-semibold">
            View My Work
          </a>
          <a href="#contact" className="px-8 py-3 border-2 border-purple-400 text-purple-400 rounded-lg hover:bg-purple-400/10 transition font-semibold">
            Get In Touch
          </a>
        </div>

        <div className="flex justify-center gap-6 text-slate-400">
          <a href="https://github.com/prasanga73" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition">
          ...
          <a href="https://linkedin.com/in/prasanga-niraula" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition">
          ...
          <a href="mailto:prasanganiraula2016@gmail.com" className="hover:text-primary transition">
